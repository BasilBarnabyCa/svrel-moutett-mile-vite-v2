<template>
	<section class="bg-gradient-to-r from-[#42275a] via-[#5b3d6a] to-[#734b6d] py-24 text-white">
		<div class="max-w-4xl mx-auto px-4 text-center">
			...
			<h2 class="text-xl md:text-2xl font-thin mb-5">Sign Up For Updates and Exclusives</h2>

			<!-- Email Input Form -->
			<form ref="contactForm" id="contact-form" @submit.prevent="sendEmail"
				...
				<div class="flex w-full md:w-2/3 justify-between items-center space-x-4">
					<input type="text" name="from_name" placeholder="Full name"
						class="w-full md:w-1/2 px-4 py-2 text-gray-800 rounded-md focus:outline-none" required />
				...
				<div class="flex w-full md:w-2/3">
					<input type="email" name="reply_to" placeholder="Email"
						class="w-full px-4 py-2 text-gray-800 rounded-md focus:outline-none" required />
				</div>

				<!-- Row 3: Textarea -->
				<div class="flex w-full md:w-2/3">
					<textarea name="message" class="w-full px-4 py-2 text-gray-800 rounded-md focus:outline-none"
						id="comment" rows="5" placeholder="Your message" required></textarea>
				</div>
			...
			<!-- Subscription Heading -->
			<h2 class="text-xl md:text-2xl font-thin mb-5 mt-20">FOLLOW FOR UPDATES AND EXCLUSIVES</h2>
